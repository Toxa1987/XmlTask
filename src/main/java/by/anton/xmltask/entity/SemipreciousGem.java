...
public class SemipreciousGem extends AbstractGem{
    ...
    private Preciousness preciousness = Preciousness.SEMIPRECIOUS;
    ...
    public SemipreciousGem(String id, String uniqueness, String name, GemOrigin gemOrigin, int value, int hardness, YearMonth timeOfExtraction, int transparency, GemColor gemColor) {
